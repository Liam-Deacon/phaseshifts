...
try:
    import phaseshifts  # noqa: F401,F403
except ImportError:
    phaseshifts = None  # type: ignore
...
project = "phaseshifts"
copyright = "2013-{}, Liam Deacon".format(datetime.date.today().year)
...
html_short_title = "phaseshifts"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "phaseshifts.png"
...
html_static_path = [  # type: ignore
    # "_static"  # TODO: Add static assets if needed for HTML
]
...
man_pages = [("index", "phaseshifts", "phaseshifts Documentation", ["Liam Deacon"], 1)]
